    ...
    <div className='container' style={{background: "white",}}>
      <div className='contact-form' style={{background: "white", height: "auto", maxWidth: "50rem", margin: "auto"}}>
        <div className='main' style={{display: "flex"}}>
          ...
          <div>
          <h1 style={{textAlign: "center", color: "darkgreen", fontSize: "35px" }}> <i>Get in Touch</i> </h1>
          </div>
        </div>
        <form action="https://formspree.io/f/mwkdyaor" method='POST' className='contact-input' style={{display: "flex",flexDirection: "column", marginTop: "20px", gap: "0.5rem"}}>
          ...
          autoComplete='off' 
          required 
          style={{width: "400px", height: "30px", cursor: 'pointer', borderRadius: "05px" }}
          />
         ...
         <input 
          ...
          autoComplete='off'  
          required 
          style={{width: "400px", height: "30px", borderRadius: "05px"}}
          />
